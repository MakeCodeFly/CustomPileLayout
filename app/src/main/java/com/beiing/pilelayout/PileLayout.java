...
public class PileLayout extends ViewGroup {
    ...
    public PileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        vertivalSpace = ta.getDimension(R.styleable.PileLayout_PileLayout_vertivalSpace, dp2px(4));//行距
        pileWidth = ta.getDimension(R.styleable.PileLayout_PileLayout_pileWidth, dp2px(10));//重叠宽度
        ta.recycle();
    }
